...
const pages = [
  ...
  { title: 'Room', subItems: ['Room Details'] },
  { title: 'Booking', subItems: ['Booking Details'] },
  { title: 'Payment', subItems: ['Payment Details'] },
  { title: 'Services Request', subItems: ['Services Details'] },
  { title: 'Report', subItems: ['Report update', 'Report analysis'] },
];
